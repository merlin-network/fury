...
type ProposalVotePayload struct {
	...
	Vote ProposalVote `protobuf:"varint,2,opt,name=vote,proto3,enum=merlinnetwork.fury.dvm.ProposalVote" json:"vote,omitempty"`
}
...
func init() {
	proto.RegisterType((*PubkeysChangeProposalPayload)(nil), "merlinnetwork.fury.dvm.PubkeysChangeProposalPayload")
	proto.RegisterType((*ProposalVotePayload)(nil), "merlinnetwork.fury.dvm.ProposalVotePayload")
}
