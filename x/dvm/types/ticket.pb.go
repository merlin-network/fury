...
type ProposalVotePayload struct {
	...
	Vote ProposalVote `protobuf:"varint,2,opt,name=vote,proto3,enum=fanfury.fury.dvm.ProposalVote" json:"vote,omitempty"`
}
...
func init() {
	proto.RegisterType((*PubkeysChangeProposalPayload)(nil), "fanfury.fury.dvm.PubkeysChangeProposalPayload")
	proto.RegisterType((*ProposalVotePayload)(nil), "fanfury.fury.dvm.ProposalVotePayload")
}
