...
type PublicKeysChangeFinishedProposal struct {
	...
	Result ProposalResult `protobuf:"varint,2,opt,name=result,proto3,enum=fanfury.fury.dvm.ProposalResult" json:"result,omitempty"`
...
func init() {
	proto.RegisterEnum("fanfury.fury.dvm.ProposalResult", ProposalResult_name, ProposalResult_value)
	proto.RegisterType((*PublicKeysChangeProposal)(nil), "fanfury.fury.dvm.PublicKeysChangeProposal")
	proto.RegisterType((*PublicKeysChangeFinishedProposal)(nil), "fanfury.fury.dvm.PublicKeysChangeFinishedProposal")
}
