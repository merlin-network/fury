...
type Bet struct {
	...
	OddsType OddsType `protobuf:"varint,4,opt,name=odds_type,json=oddsType,proto3,enum=merlinnetwork.fury.bet.OddsType" json:"odds_type,omitempty"`
	...
	Status Bet_Status `protobuf:"varint,8,opt,name=status,proto3,enum=merlinnetwork.fury.bet.Bet_Status" json:"status,omitempty"`
	// result is the result of the bet, such as `won` or `lost`.
	Result Bet_Result `protobuf:"varint,9,opt,name=result,proto3,enum=merlinnetwork.fury.bet.Bet_Result" json:"result,omitempty"`
...
func init() {
	proto.RegisterEnum("merlinnetwork.fury.bet.Bet_Status", Bet_Status_name, Bet_Status_value)
	proto.RegisterEnum("merlinnetwork.fury.bet.Bet_Result", Bet_Result_name, Bet_Result_value)
	proto.RegisterType((*Bet)(nil), "merlinnetwork.fury.bet.Bet")
	proto.RegisterType((*UID2ID)(nil), "merlinnetwork.fury.bet.UID2ID")
	proto.RegisterType((*ActiveBet)(nil), "merlinnetwork.fury.bet.ActiveBet")
	proto.RegisterType((*SettledBet)(nil), "merlinnetwork.fury.bet.SettledBet")
	proto.RegisterType((*BetFulfillment)(nil), "merlinnetwork.fury.bet.BetFulfillment")
}
