...
func init() {
	proto.RegisterType((*MsgPlaceBet)(nil), "merlinnetwork.fury.bet.MsgPlaceBet")
	proto.RegisterType((*MsgPlaceBetResponse)(nil), "merlinnetwork.fury.bet.MsgPlaceBetResponse")
}
...
func (c *msgClient) PlaceBet(ctx context.Context, in *MsgPlaceBet, opts ...grpc.CallOption) (*MsgPlaceBetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.fury.bet.Msg/PlaceBet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_PlaceBet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.fury.bet.Msg/PlaceBet",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "merlinnetwork.fury.bet.Msg",
