...
func init() {
	proto.RegisterType((*MsgPlaceBet)(nil), "fanfury.fury.bet.MsgPlaceBet")
	proto.RegisterType((*MsgPlaceBetResponse)(nil), "fanfury.fury.bet.MsgPlaceBetResponse")
}
...
func (c *msgClient) PlaceBet(ctx context.Context, in *MsgPlaceBet, opts ...grpc.CallOption) (*MsgPlaceBetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fanfury.fury.bet.Msg/PlaceBet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_PlaceBet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fanfury.fury.bet.Msg/PlaceBet",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fanfury.fury.bet.Msg",
