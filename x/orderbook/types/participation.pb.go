...
func init() {
	proto.RegisterType((*BookParticipation)(nil), "fanfury.fury.orderbook.BookParticipation")
	proto.RegisterType((*ParticipationBetPair)(nil), "fanfury.fury.orderbook.ParticipationBetPair")
}
