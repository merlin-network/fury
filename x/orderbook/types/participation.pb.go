...
func init() {
	proto.RegisterType((*BookParticipation)(nil), "merlinnetwork.fury.orderbook.BookParticipation")
	proto.RegisterType((*ParticipationBetPair)(nil), "merlinnetwork.fury.orderbook.ParticipationBetPair")
}
