...
type OrderBook struct {
	...
	// order book status
	Status OrderBookStatus `protobuf:"varint,4,opt,name=status,proto3,enum=merlinnetwork.fury.orderbook.OrderBookStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterEnum("merlinnetwork.fury.orderbook.OrderBookStatus", OrderBookStatus_name, OrderBookStatus_value)
	proto.RegisterType((*OrderBook)(nil), "merlinnetwork.fury.orderbook.OrderBook")
}
