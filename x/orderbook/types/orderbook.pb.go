...
type OrderBook struct {
	...
	// order book status
	Status OrderBookStatus `protobuf:"varint,4,opt,name=status,proto3,enum=fanfury.fury.orderbook.OrderBookStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterEnum("fanfury.fury.orderbook.OrderBookStatus", OrderBookStatus_name, OrderBookStatus_value)
	proto.RegisterType((*OrderBook)(nil), "fanfury.fury.orderbook.OrderBook")
}
