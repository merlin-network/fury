...
func init() {
	proto.RegisterType((*SportEventAddTicketPayload)(nil), "merlinnetwork.fury.sportevent.SportEventAddTicketPayload")
	proto.RegisterType((*SportEventUpdateTicketPayload)(nil), "merlinnetwork.fury.sportevent.SportEventUpdateTicketPayload")
	proto.RegisterType((*SportEventResolutionTicketPayload)(nil), "merlinnetwork.fury.sportevent.SportEventResolutionTicketPayload")
}
