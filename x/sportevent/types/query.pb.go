...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "fanfury.fury.sportevent.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "fanfury.fury.sportevent.QueryParamsResponse")
	proto.RegisterType((*QuerySportEventRequest)(nil), "fanfury.fury.sportevent.QuerySportEventRequest")
	proto.RegisterType((*QuerySportEventResponse)(nil), "fanfury.fury.sportevent.QuerySportEventResponse")
	proto.RegisterType((*QuerySportEventsRequest)(nil), "fanfury.fury.sportevent.QuerySportEventsRequest")
	proto.RegisterType((*QuerySportEventsResponse)(nil), "fanfury.fury.sportevent.QuerySportEventsResponse")
	proto.RegisterType((*QuerySportEventsByUIDsRequest)(nil), "fanfury.fury.sportevent.QuerySportEventsByUIDsRequest")
	proto.RegisterType((*QuerySportEventsByUIDsResponse)(nil), "fanfury.fury.sportevent.QuerySportEventsByUIDsResponse")
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fanfury.fury.sportevent.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) SportEvent(ctx context.Context, in *QuerySportEventRequest, opts ...grpc.CallOption) (*QuerySportEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fanfury.fury.sportevent.Query/SportEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) SportEvents(ctx context.Context, in *QuerySportEventsRequest, opts ...grpc.CallOption) (*QuerySportEventsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fanfury.fury.sportevent.Query/SportEvents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) SportEventsByUIDs(ctx context.Context, in *QuerySportEventsByUIDsRequest, opts ...grpc.CallOption) (*QuerySportEventsByUIDsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fanfury.fury.sportevent.Query/SportEventsByUIDs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fanfury.fury.sportevent.Query/Params",
	}
...
func _Query_SportEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fanfury.fury.sportevent.Query/SportEvent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_SportEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fanfury.fury.sportevent.Query/SportEvents",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_SportEventsByUIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fanfury.fury.sportevent.Query/SportEventsByUIDs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fanfury.fury.sportevent.Query",
