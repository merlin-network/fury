...
func init() {
	proto.RegisterType((*MsgAddSportEvent)(nil), "merlinnetwork.fury.sportevent.MsgAddSportEvent")
	proto.RegisterType((*MsgAddSportEventResponse)(nil), "merlinnetwork.fury.sportevent.MsgAddSportEventResponse")
	proto.RegisterType((*MsgResolveSportEvent)(nil), "merlinnetwork.fury.sportevent.MsgResolveSportEvent")
	proto.RegisterType((*MsgResolveSportEventResponse)(nil), "merlinnetwork.fury.sportevent.MsgResolveSportEventResponse")
	proto.RegisterType((*MsgUpdateSportEvent)(nil), "merlinnetwork.fury.sportevent.MsgUpdateSportEvent")
	proto.RegisterType((*MsgUpdateSportEventResponse)(nil), "merlinnetwork.fury.sportevent.MsgUpdateSportEventResponse")
}
...
func (c *msgClient) AddSportEvent(ctx context.Context, in *MsgAddSportEvent, opts ...grpc.CallOption) (*MsgAddSportEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.fury.sportevent.Msg/AddSportEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ResolveSportEvent(ctx context.Context, in *MsgResolveSportEvent, opts ...grpc.CallOption) (*MsgResolveSportEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.fury.sportevent.Msg/ResolveSportEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateSportEvent(ctx context.Context, in *MsgUpdateSportEvent, opts ...grpc.CallOption) (*MsgUpdateSportEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.fury.sportevent.Msg/UpdateSportEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddSportEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.fury.sportevent.Msg/AddSportEvent",
	}
...
func _Msg_ResolveSportEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.fury.sportevent.Msg/ResolveSportEvent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateSportEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.fury.sportevent.Msg/UpdateSportEvent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "merlinnetwork.fury.sportevent.Msg",
