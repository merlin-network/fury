...
func init() {
	proto.RegisterType((*MsgDeposit)(nil), "merlinnetwork.fury.house.MsgDeposit")
	proto.RegisterType((*MsgDepositResponse)(nil), "merlinnetwork.fury.house.MsgDepositResponse")
	proto.RegisterType((*MsgWithdraw)(nil), "merlinnetwork.fury.house.MsgWithdraw")
	proto.RegisterType((*MsgWithdrawResponse)(nil), "merlinnetwork.fury.house.MsgWithdrawResponse")
}
...
func (c *msgClient) Deposit(ctx context.Context, in *MsgDeposit, opts ...grpc.CallOption) (*MsgDepositResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.fury.house.Msg/Deposit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Withdraw(ctx context.Context, in *MsgWithdraw, opts ...grpc.CallOption) (*MsgWithdrawResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.fury.house.Msg/Withdraw", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Deposit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.fury.house.Msg/Deposit",
	}
...
func _Msg_Withdraw_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.fury.house.Msg/Withdraw",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "merlinnetwork.fury.house.Msg",
