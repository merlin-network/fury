...
func init() {
	proto.RegisterEnum("merlinnetwork.fury.house.WithdrawalMode", WithdrawalMode_name, WithdrawalMode_value)
	proto.RegisterType((*Withdrawal)(nil), "merlinnetwork.fury.house.Withdrawal")
}
