...
```shell
furyd init {{NODE_NAME}} --chain-id merlin-network-1
```
...
```shell
wget https://github.com/merlin-network/networks/blob/master/merlin-network-1/genesis.json -O ~/.furyd/config/genesis.json
```
